...
class adminController extends Controller
{
    ...
    public  $website = "support@trustbunds.com";
...
public function faqs_delete(Request $request)
{
    ...
    if ($result) {
        # code...
        return back()->with("warning", "Faq deleted successfully");
    } else {
        # code...
...
public function cards()
{
   ...
   // FrankS functions here
    ...
    //     if ($result) {
    //         # code...
    //         return redirect()->route("pages")->with("warning", "top user deleted successfully");
    //     } else {
    //         # code...
