...
<head>
    ...
    <title>Welcome | Gold Block Assets | Bitcoin Investment | Cryptocurrency Investment | Etherium Investment</title>
...
<body class="boxed_wrapper ltr">
        ...
        <nav class="menu-box">
            ...
            <div class="contact-info">
                ...
                <ul>
                    ...
                    <li><a href="mailto:support@goldblockassets.com">support@goldblockassets.com</a></li>
                </ul>
            </div>
    ...
    <footer class="main-footer">
                ...
                <div class="widget-section">
                            ...
                            <div class="footer-widget logo-widget">
                                ...
                                <ul class="info-list clearfix">
                                    ...
                                    <li><i class="fas fa-envelope"></i>Email <a
                                            href="mailto:support@goldblockassets.com">support@goldblockassets.com</a>
                                    </li>
                                    <li><i class="fas fa-globe"></i>Website goldblockassets.com</li>
                                    <li><a class="theme-btn style-one"
                                            href="https://find-and-update.company-information.service.gov.uk/company/13485600">Company
                                            Number: 13485600</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 footer-column">
                        <div class="footer-widget links-widget ml-70">
                            ...
                            <div class="text">
                                <p>
                                    Gold Block Assets is a member of The Financial Commission, an international organization engaged in
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 footer-column">
                        <div class="footer-widget links-widget ml-70">
                            ...
                            <div class="text">
                                <p>
                                    Gold Block Assets is regulated by the US Securities and Exchange Commission. The mission of the SEC is to protect
                     investors; maintain fair,
                     orderly, and efficient markets; and facilitate capital formation.
                     
                     Gold Block Assets is an investment company that . Direct access to over 50 financial markets
                     ...
                     Gold Block Assets is a registered investment dealer, a member of the
                     ...
                     activities undertaken by Gold Block Assets.
                                </p>
                            </div>
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="copyright">
                    <p>&copy; 2017 - 2022 <a href="index-2.html">Gold Block Assets</a> . All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
