...
<main class="special-trades-contents whatweinvestin-page">
	...
	<section>
		...
		<div class="paragraph">
			<h3>What is ERC 20 and what does it provide for an FUNDFLUX Investor &quest;</h3>
			<p>
				...
				<br>
				And that is why at FUNDFLUX Financial Management we tailor our clients need and create a diversified portfolio inclusive of new and high prospective offerings in the digital space.
			</p>
		</div>
		<div class="paragraph">
			...
			<p>
				{{$compd? $compd->Companyname: 'FUNDFLUX'}} Financial Management board members are in connection with great development teams precisely developing cryptocurrency using the ERC 20 token standard and history has proven to give one of the best projects yields.
			</p>
			<p>
...
With smart contracts at the core, dozens of DeFi applications are operating on Ethereum, some of which are explored below. Ethereum 2.0, a coming upgrade to Ethereum’s underlying network, could give these apps a boost by chipping away at Ethereum’s scalability issues.
		...
		<div class="paragraph">
			...
			<p>
				{{$compd? $compd->Companyname: 'FUNDFLUX'}} Financial Management traders' are sophisticated investors with years of experience in IPO's who bring on their skills and experience to the crypto industry and other disruptive markets. We prepare your account for IEO's and yield farming investments by performing a vast due diligence across multiple exchanges offering any of these services. Should you decide to subscribe to this plan, your trader will inform you if your funds will be invested in IEO or Yield Farming.	
			</p>
			<p>
