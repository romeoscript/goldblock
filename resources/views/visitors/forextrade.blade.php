...
<main class="forex-contents whatweinvestin-page">
    ...
    <section>
    	...
    	<p>
    		The need to exchange currencies is the primary reason why the forex market is the largest, most liquid financial market in the world. It dwarfs other markets in size, even the stock market, with an average traded value of around the U.S. $2 billion per day. (The total volume changes all the time, but as of August 2012, the Bank for International Settlements (BIS) reported that the forex market traded in excess of U.S. $5.1 trillion per day.)
    	</p>
    	<p>
        ...
        <div class="paragraph">
        	<h4>Spot Market and the Forwards and Futures Markets</h4>
        	<p>
        ...
        <div class="paragraph">
        	<h4>What is the spot market &quest;</h4>
        	<p>
        ...
        <div class="paragraph">
        	<h4>What are the forwards and futures markets &quest;</h4>
        	<p>Unlike the spot market, the forwards and futures markets do not trade actual currencies. Instead, they deal in contracts that represent claims to a certain currency type, a specific price per unit, and a future date for settlement.
        	<br>
...
Note that you’ll see the terms:<i> FX, forex, foreign-exchange market, and currency market. These terms are synonymous and all refer to the forex market.</i>
            </p>
        </div>
        <div class="paragraph">
        	<h3>
        	...
        	<ul>
        		<li>
        			Set up an account: You will need a forex trading account at a brokerage to get started with forex trading. FUNDFLUX financial management does not charge commissions. Instead, we make money through spreads (also known as pips) between the buying and selling prices.
        		</li>
        		<li>
